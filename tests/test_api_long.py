...
class TestShotgunApiLong(base.LiveTestBase):
    ...
    def test_schema(self):
        ...
        # An explanation is in order here. the field code that is created in shotgun_repos is based on the human display name
        ...
        # called "Monkey Count" will now fail due to the new Delete Field Forever features we have added to shotgun_repos
